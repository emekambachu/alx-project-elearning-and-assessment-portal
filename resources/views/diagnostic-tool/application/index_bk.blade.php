                                                        ...
                                                        <div class="col-md-12 form-group">
                                                            <label class="form-text">How did you hear about this program?<span class="text-danger">*</span>
                                                                <select name="referred_by" id="referral-type-part-3" required class="form-control" onchange="referralevent()" />
                                                                    <option value="" selected>-- Select --</option>
                                                                    <option value="ALX | E-learning and Assessment Portal">ALX | E-learning and Assessment Portal</option>
...
{{--                                                    {{ __('Are You an Agripreneur? Sign up to join the ALX | E-learning and Assessment Portal Community') }}--}}
{{--                                                </a>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-md-12 text-center p-3">--}}
...
{{--                                                   {{ __('Go to ALX | E-learning and Assessment Portal Home Page') }}--}}
{{--                                                </a>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
