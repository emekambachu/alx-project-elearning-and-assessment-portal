    ...
    <div>
        ...
        <Teleport to="section">
            <admin-module-form
                ...
                @emitting-submitted-module="submittedModule"
            ></admin-module-form>
        </Teleport>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form @submit.prevent="searchModules" style="margin-bottom: 4px;">
                        <div class="row p-3">
                            <div class="col-12">
        ...
        <laravel-vue-pagination v-if="searchActive"
                                ...
                                :limit="3"
                                :data="modules"
                                @pagination-change-page="searchModules"
        >
            <template #prev-nav>
                <span>&lt; Previous</span>
            </template>
...
export default {
    ...
    setup(){
        ...
        const submittedModule = (event) => {
            console.log(event);
            modules.value.data.unshift(event);
        }

        const getModules = (page = 1) => {
