<template>
    ...
    <laravel-vue-pagination v-if="searchActive"
                            ...
                            :limit="3"
                            :data="applications"
                            @pagination-change-page="searchApplications"
    >
        <template #prev-nav>
            <span>&lt; Previous</span>
        </template>
...
<script>
    ...
    export default {
        ...
        setup(){
            ...
            const searchApplications = (page = 1) => {
            ...
            const getCountries = async () => {
                await axios.get('/api/countries/africa')
                    .then((response) => {
