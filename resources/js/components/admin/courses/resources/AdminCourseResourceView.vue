<template>
    ...
    <div>
        <div class="row">
            <div class="col-12">
                <h4 class="content-header">Course Resources | {{ course.title }}</h4>
            </div>
        ...
        <Teleport to="section">
            <admin-course-resource-form
                ...
                @emitting-submitted-resource="submittedResource"
            ></admin-course-resource-form>
        </Teleport>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered small table-hover table-responsive-sm mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="border-top-0">Resources</th>
...
<script>
import AdminCourseResourceItem from "./AdminCourseResourceItem.vue";
...
export default {
    ...
    setup(){
        ...
        const submittedResource = (event) => {
            console.log(event);
            resources.value.unshift(event);
        }

        const getResources = () => {
            searchActive.value = false;
            dataLoaded.value = false;
            axios.get('/api/admin/course/resources', {
