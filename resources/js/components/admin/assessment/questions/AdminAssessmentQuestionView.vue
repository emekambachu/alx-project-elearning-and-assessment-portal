<template>
    ...
    <div>
        <div class="row">
            <div class="col-12">
                <h4 class="content-header">Assessment Questions | {{ module.title }}</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12 justify-content-center d-flex">
                <button class="btn btn-md btn-info" @click.prevent="isOpen = true">
                    Add assessment question to this module
                </button>
            </div>
        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered small table-hover table-responsive-sm mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="border-top-0">Options / Correct Answer</th>
                                    ...
                                    <template v-if="dataLoaded">
                                        <admin-assessment-question-item
...
import AdminAssessmentQuestionItem from "./AdminAssessmentQuestionItem.vue";
...
export default {
    ...
    setup(){
        ...
        const submittedQuestion = (event) => {
            console.log(event);
            questions.value.unshift(event);
        }

        const getQuestions = (page = 1) => {
            searchActive.value = false;
            dataLoaded.value = false;
            axios.get('/api/admin/module/assessment/questions', {
