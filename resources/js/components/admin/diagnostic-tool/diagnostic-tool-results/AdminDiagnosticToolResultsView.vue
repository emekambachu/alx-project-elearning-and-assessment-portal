...
import {
    ...
    import AdminDiagnosticToolResultsItem from "./AdminDiagnosticToolResultsItem.vue";
    ...
    const searchDiagnostics = (page = 1) => {
...
<template>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form @submit.prevent="searchDiagnostics" style="margin-bottom: 4px;">
                    <div class="row p-3">
                        <div class="col-12">
                        ...
                        <div class="col-md-12 d-flex justify-content-center"
                            ...
                            <a :href="'/admin/diagnostic-tool/results/export/' + JSON.stringify(form)">
                            ...
                            <table class="table table-striped table-bordered small table-hover table-responsive-sm mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="border-top-0">Diagnostic Status</th>
                                        <th class="border-top-0">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <template v-if="dataLoaded">
                                        <admin-diagnostic-tool-results-item
                                            v-for="user in diagnostics.data"
                                            :key="user.id"
                                            :user="user"
                                        ></admin-diagnostic-tool-results-item>
                                    </template>
    ...
    <laravel-vue-pagination v-if="!searchActive"
                            ...
                            :limit="3"
                            :data="diagnostics"
                            @pagination-change-page="getDiagnostics"
    >
        <template #prev-nav>
            <span>&lt; Previous</span>
        </template>
    ...
    <laravel-vue-pagination v-if="searchActive"
                            ...
                            :limit="3"
                            :data="diagnostics"
                            @pagination-change-page="searchDiagnostics"
    >
        <template #prev-nav>
            <span>&lt; Previous</span>
        </template>
